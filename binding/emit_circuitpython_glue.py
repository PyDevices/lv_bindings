"""CircuitPython bookends: phase-2 enums and LVCP_MODULE_GLOBALS module table."""
...
def emit_phase2_enums():
    """Emit enum type objects (same C shape as emit_c_micropython_style.gen_obj for enum keys)."""
