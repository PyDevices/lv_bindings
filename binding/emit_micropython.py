...
def run(ctx):
    ...
    # The MP-style object/enum pass has a full-generation dependency that is
    # intentionally represented by an unbounded phase. CircuitPython and
    # CPython use their finite lifecycle phases below.
